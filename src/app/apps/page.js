...
export const metadata = {
  ...
  description:
    "Browse mobile apps and extensions created by Anwer Solangi. React Native apps, Chrome extensions, and more.",
  openGraph: {
    title: "Apps | Anwer Solangi",
  ...
  return (
    <main className="container mx-auto px-4 pt-32 pb-12">
      ...
      <p className="text-lg text-center mb-16 text-gray-600 max-w-2xl mx-auto">
        Check out some of the apps I&apos;ve built. Each one is crafted with
